...
void stepperRot(float rev_L, float rev_R, float speed){
  ...
  // setProfileMotorSep(0, speedL, accelSpeed);
  // setProfileMotorSep(1, speedR, accelSpeed);
  ...
  // double avgSteps = (moveSteps_L + moveSteps_R) / 2.0;
  // if(avgSteps != moveSteps_L){
  //   float adjustSpeed_L = speed * (moveSteps_L / avgSteps);
  //   float adjustAccel_L = accelSpeed * (moveSteps_L / avgSteps);
  //   setProfileMotorSep(0, adjustSpeed_L, adjustAccel_L);
  //   float adjustSpeed_R = speed * (moveSteps_R / avgSteps);
  //   float adjustAccel_R = accelSpeed * (moveSteps_R / avgSteps);
  //   setProfileMotorSep(1,adjustSpeed_R, adjustAccel_R);
  // }else{
...
void setup() {
  ...
  // if(microStepSetting == 2){
  //   digitalWrite(stepControlPin[1], LOW);    
  //   digitalWrite(stepControlPin[2], LOW);    
  // }
  ...
  // stepperRot(0.25f, -0.25f, speeds[0]);
  ...
  // Bridge.provide("pythonCoord", pythonCoord);
